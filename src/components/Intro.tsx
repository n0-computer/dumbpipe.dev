...
export function Intro() {
  return (
    <>
      ...
      <h1 className="mt-14 font-title text-lg/tight md:text-2xl font-light text-gray-500">Need to connect two devices? Try a</h1>
      <h1 className="font-title text-7xl/tight md:text-8xl font-light text-gray-500">
        <span className="text-gray-950">dumb pipe</span>
      </h1>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Made by{' '}
      <IconLink href="https://twitter.com/n0computer" icon={TwitterIcon} compact large>
        number 0
      </IconLink>
    </p>
  )
